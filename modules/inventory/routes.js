...
router.get('/products/:id/history', requireRole(...readRoles), inventoryController.getProductHistory);
router.put('/products/:id/documents', requireRole(...writeRoles), inventoryController.updateProductDocuments);
